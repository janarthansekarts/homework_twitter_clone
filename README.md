...
This project was built to explore backend concepts in Laravel, including:
- Routing and controllers
- Database migrations and relationships
- API-style request handling
- Authentication basics

It’s not a production app, but a structured learning project used to solidify backend fundamentals.
``
